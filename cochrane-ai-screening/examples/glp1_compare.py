# same code as insulin compare6.py(only file name changed)
...
# python compare2.py 2>&1 | tee output.txt
...
def main():
    ...
    try:
        ...
        python_include_maybe = comparer.load_python_include_maybe('screening_decisions_comprehensive.csv')
